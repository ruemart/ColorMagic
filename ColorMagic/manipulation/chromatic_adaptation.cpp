...
color_space::color_base * color_manipulation::color_adjustments::cmccat2000_adaptation(color_space::color_base * color, color_space::white_point * target_white_point)
{
	...
	return cmccat2000_adaptation(color, color_space_def);
}

color_space::color_base * color_manipulation::color_adjustments::cmccat2000_adaptation(color_space::color_base * color, color_space::rgb_color_space_definition * target_color_space, float f, float adapting_field_luminance, float reference_field_luminance)
{
	...
	auto scaled_dest_wp = m_cmccat2000 * std::vector<float> { target_color_space->get_white_point()->get_tristimulus().begin(), target_color_space->get_white_point()->get_tristimulus().end() };
	...
	auto wp_y_factor = d * (color->get_rgb_color_space()->get_white_point()->get_tristimulus_y() / target_color_space->get_white_point()->get_tristimulus_y());
	...
	auto tmp_trans_color = new color_space::xyz(transformed_components[0], transformed_components[1], transformed_components[2], color->alpha(), target_color_space);
...
color_space::color_base * color_manipulation::color_adjustments::cmccat2000_adaptation(color_space::color_base * color, color_space::white_point * target_white_point, float f, float adapting_field_luminance, float reference_field_luminance)
{
	...
	return cmccat2000_adaptation(color, color_space_def, f, adapting_field_luminance, reference_field_luminance);
}
...
color_space::color_base * color_manipulation::color_adjustments::do_adaption(color_space::color_base * color, color_space::rgb_color_space_definition * target_color_space, matrix<float> mat, matrix<float> inverted_mat)
{
	...
	auto scaled_dest_wp = mat * std::vector<float> { target_color_space->get_white_point()->get_tristimulus().begin(), target_color_space->get_white_point()->get_tristimulus().end() };
