...
color_space::rgb_truecolor * color_manipulation::color_calculation::add(color_space::rgb_truecolor * color1, color_space::rgb_truecolor * color2, float weight1, float weight2, bool includeAlpha)
{
	...
	return new color_space::rgb_truecolor(fminf(fmaxf(r, 0), 255), fminf(fmaxf(g, 0), 255), fminf(fmaxf(b, 0), 255), fminf(fmaxf(a, 0), 255), color1->m_reference_white);
}
...
color_space::rgb_deepcolor * color_manipulation::color_calculation::add(color_space::rgb_deepcolor * color1, color_space::rgb_deepcolor * color2, float weight1, float weight2, bool includeAlpha)
{
	...
	return new color_space::rgb_deepcolor(r, g, b, a, color1->m_reference_white);
}
...
color_space::grey_truecolor * color_manipulation::color_calculation::add(color_space::grey_truecolor * color1, color_space::grey_truecolor * color2, float weight1, float weight2, bool includeAlpha)
{
	...
	return new color_space::grey_truecolor(fminf(fmaxf(v, 0), 255), fminf(fmaxf(a, 0), 255), color1->m_reference_white);
}
...
color_space::grey_deepcolor * color_manipulation::color_calculation::add(color_space::grey_deepcolor * color1, color_space::grey_deepcolor * color2, float weight1, float weight2, bool includeAlpha)
{
	...
	return new color_space::grey_deepcolor(v, a, color1->m_reference_white);
}
...
color_space::cmyk * color_manipulation::color_calculation::add(color_space::cmyk * color1, color_space::cmyk * color2, float weight1, float weight2)
{
	...
	return new color_space::cmyk(c, m, y, k, color1->m_reference_white);
}
...
color_space::hsv * color_manipulation::color_calculation::add(color_space::hsv * color1, color_space::hsv * color2, float weight1, float weight2)
{
	...
	return new color_space::hsv(vector2[0], vector2[1], vector2[2], color1->m_reference_white);
}
...
color_space::xyz * color_manipulation::color_calculation::add(color_space::xyz * color1, color_space::xyz * color2, float weight1, float weight2)
{
	...
	return new color_space::xyz(x, y, z, color1->m_reference_white);
}
...
color_space::rgb_truecolor * color_manipulation::color_calculation::subtract(color_space::rgb_truecolor * color1, color_space::rgb_truecolor * color2, float weight, bool includeAlpha)
{
	...
	return new color_space::rgb_truecolor(r, g, b, includeAlpha ? color1->alpha() - weight * color2->alpha() : color1->alpha(), color1->m_reference_white);
}
...
color_space::rgb_deepcolor * color_manipulation::color_calculation::subtract(color_space::rgb_deepcolor * color1, color_space::rgb_deepcolor * color2, float weight, bool includeAlpha)
{
	...
	return new color_space::rgb_deepcolor(r, g, b, includeAlpha ? color1->alpha() - weight * color2->alpha() : color1->alpha(), color1->m_reference_white);
}
...
color_space::grey_truecolor * color_manipulation::color_calculation::subtract(color_space::grey_truecolor * color1, color_space::grey_truecolor * color2, float weight, bool includeAlpha)
{
	...
	return new color_space::grey_truecolor(color1->grey() - weight * color2->grey(), includeAlpha ? color1->alpha() - weight * color2->alpha() : color1->alpha(), color1->m_reference_white);
}
...
color_space::grey_deepcolor * color_manipulation::color_calculation::subtract(color_space::grey_deepcolor * color1, color_space::grey_deepcolor * color2, float weight, bool includeAlpha)
{
	...
	return new color_space::grey_deepcolor(color1->grey() - weight * color2->grey(), includeAlpha ? color1->alpha() - weight * color2->alpha() : color1->alpha(), color1->m_reference_white);
}
...
color_space::rgb_truecolor * color_manipulation::color_calculation::average_rgb_true(std::vector<color_space::rgb_truecolor*> colors)
{
	...
	return new color_space::rgb_truecolor(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), sum[3] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::rgb_deepcolor * color_manipulation::color_calculation::average_rgb_deep(std::vector<color_space::rgb_deepcolor*> colors)
{
	...
	return new color_space::rgb_deepcolor(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), sum[3] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::grey_truecolor * color_manipulation::color_calculation::average_grey_true(std::vector<color_space::grey_truecolor*> colors)
{
	...
	return new color_space::grey_truecolor(sum[0] / colors.size(), sum[1] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::grey_deepcolor * color_manipulation::color_calculation::average_grey_deep(std::vector<color_space::grey_deepcolor*> colors)
{
	...
	return new color_space::grey_deepcolor(sum[0] / colors.size(), sum[1] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::cmyk * color_manipulation::color_calculation::average_cmyk(std::vector<color_space::cmyk*> colors)
{
	...
	return new color_space::cmyk(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), sum[3] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::hsv * color_manipulation::color_calculation::average_hsv(std::vector<color_space::hsv*> colors)
{
	...
	return new color_space::hsv(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::hsl * color_manipulation::color_calculation::average_hsl(std::vector<color_space::hsl*> colors)
{
	...
	return new color_space::hsl(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::xyz * color_manipulation::color_calculation::average_xyz(std::vector<color_space::xyz*> colors)
{
	...
	return new color_space::xyz(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), colors[0]->m_reference_white);
}
...
color_space::lab * color_manipulation::color_calculation::average_lab(std::vector<color_space::lab*> colors)
{
	...
	return new color_space::lab(sum[0] / colors.size(), sum[1] / colors.size(), sum[2] / colors.size(), colors[0]->m_reference_white);
}
