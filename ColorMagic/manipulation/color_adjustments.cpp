...
void color_adjustments::saturate(color_space::color_base &color, float percentage)
{
...
color_space::color_base * color_adjustments::saturate(color_space::color_base* color, float percentage)
{
	auto color_rgb_d = dynamic_cast<color_space::rgb_deepcolor*>(color_manipulation::color_converter::convertTo(color, color_type::RGB_DEEP));
