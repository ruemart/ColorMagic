...
{
	//! Color space to represents lch(ab) colors.
	/*!
	...
	*/
	...
	public:
		...
		*/
		lch_ab(float luminance, float chroma, float hue, float alpha, rgb_color_space_definition* color_space);

		//! Default copy constructor.
		/*!
		* Constructs a lch(ab) color from a given one.
		* \param other The lch(ab) object to construct this color from.
		*/
		lch_ab(const lch_ab& other);

		//! Default copy constructor.
		/*!
		* Constructs a lch(ab) color from a color_base object.
		* \param other The color_base object to construct this color from.
		*/
		lch_ab(const color_base& other);

		//! Assignment operator overload.
		/*!
		* Assigns the components from the right hand object to the corresponding components of the left hand object.
		* \param other The lch(ab) object to get the component values from.
		*/
		lch_ab& operator=(const lch_ab& other);
