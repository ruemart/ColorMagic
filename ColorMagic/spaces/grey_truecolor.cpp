...
color_space::grey_truecolor::grey_truecolor(float value, float alpha, reference_white* ref_white) : color_base(alpha, ref_white, 1, 255.f, 0.f)
{
	this->m_type = color_type::GREY_TRUE;
	this->grey(value);
}

color_space::grey_truecolor::grey_truecolor(const color_space::grey_truecolor & other) : color_base(other.alpha(), other.get_reference_white(), 1, other.get_component_max(), other.get_component_min())
{
	this->m_type = other.get_color_type();
	this->m_component_vector = other.get_component_vector();
}

color_space::grey_truecolor::grey_truecolor(const color_base & other) : color_base(other.alpha(), other.get_reference_white(), 1, other.get_component_max(), other.get_component_min())
{
