...
namespace color_space
{
	...
	*/
	...
	public:
		...
		* ICC profile PCS
		*/
		white_point* D50_2Degree() { return new white_point(0.9642f, 0.1f, 82.51f, 0.3456f, 0.3585f); }

		//! CIE_D55 tristimulus white (2°).
		/*!
		* Represents mid-morning / mid-afternoon daylight (5503 Kelvin).
		*/
		white_point* D55_2Degree() { return new white_point(0.9568f, 0.1f, 0.9214f, 0.3324f, 0.3474f); }

		//! CIE_D65 tristimulus white (2°)
		/*!
		* Represents noon daylight, tv, sRGB color space (6504 Kelvin)
		*/
		white_point* D65_2Degree() { return new white_point(0.9504f, 0.1f, 1.0888f, 0.3127f, 0.3290f); }

		//! CIE_D75 tristimulus white (2°)
		/*!
		* Represents north sky daylight (7504 Kelvin)
		*/
		white_point* D75_2Degree() { return new white_point(0.9497f, 0.1f, 1.2264f, 0.2990f, 0.3148f); }

		//! CIE_A tristimulus white (2°)
		/*!
		* Represents incandescent / tungsten (2856 Kelvin)
		*/
		white_point* A_2Degree() { return new white_point(0.10985f, 0.1f, 0.3558f, 0.4475f, 0.4074f); }
		...
		*/
		white_point* B_2Degree() { return new white_point(0.9909f, 0.1f, 0.8531f, 0.3484f, 0.3516f); }
		...
		*/
		white_point* C_2Degree() { return new white_point(0.9807f, 0.1f, 1.1823f, 0.3100f, 0.3161f); }

		//! CIE_E tristimulus white (2°)
		/*!
		* Represents equal energy (5454 Kelvin)
		*/
		white_point* E_2Degree() { return new white_point(0.1f, 0.1f, 0.1f, 0.3333f, 0.3333f); }

		//! CIE_F1 tristimulus white (2°)
		/*!
		* Represents daylight fluorescent (6430 Kelvin)
		*/
		white_point* F1_2Degree() { return new white_point(0.9283f, 0.1f, 1.0366f, 0.3130f, 0.3372f); }

		//! CIE_F2 tristimulus white (2°)
		/*!
		* Represents cool white fluorescent (4230 Kelvin)
		*/
		white_point* F2_2Degree() { return new white_point(0.9918f, 0.1f, 0.6739f, 0.3720f, 0.3751f); }

		//! CIE_F3 tristimulus white (2°)
		/*!
		* Represents white fluorescent (3450 Kelvin)
		*/
		white_point* F3_2Degree() { return new white_point(0.10375f, 0.1f, 0.4986f, 0.4090f, 0.3943f); }

		//! CIE_F4 tristimulus white (2°)
		/*!
		* Represents warm white fluorescent (2940 Kelvin)
		*/
		white_point* F4_2Degree() { return new white_point(0.10914f, 0.1f, 0.3881f, 0.4401f, 0.4033f); }

		//! CIE_F5 tristimulus white (2°)
		/*!
		* Represents daylight fluorescent (6350 Kelvin)
		*/
		white_point* F5_2Degree() { return new white_point(0.9087f, 0.1f, 0.9872f, 0.3137f, 0.3453f); }

		//! CIE_F6 tristimulus white (2°)
		/*!
		* Represents lite white fluorescent (4150 Kelvin)
		*/
		white_point* F6_2Degree() { return new white_point(0.9730f, 0.1f, 0.6019f, 0.3778f, 0.3883f); }

		//! CIE_F7 tristimulus white (2°)
		/*!
		* Represents D65 simulator, daylight simulator (6500 Kelvin)
		*/
		white_point* F7_2Degree() { return new white_point(0.9504f, 0.1f, 1.0875f, 0.3128f, 0.3291f); }

		//! CIE_F8 tristimulus white (2°)
		/*!
		* Represents D50 simulator, sylvania F40 design 50 (5000 Kelvin)
		*/
		white_point* F8_2Degree() { return new white_point(0.9641f, 0.1f, 0.8233f, 0.3458f, 0.3587f); }

		//! CIE_F9 tristimulus white (2°)
		/*!
		* Represents cool white deluxe fluorescent (4150 Kelvin)
		*/
		white_point* F9_2Degree() { return new white_point(0.10036f, 0.1f, 0.6786f, 0.3741f, 0.3728f); }

		//! CIE_F10 tristimulus white (2°)
		/*!
		* Represents Philips TL85, Ultralume 50 (5000 Kelvin)
		*/
		white_point* F10_2Degree() { return new white_point(0.9617f, 0.1f, 0.8171f, 0.3460f, 0.3598f); }

		//! CIE_F11 tristimulus white (2°)
		/*!
		* Represents Philips TL84, Ultralume 40 (4000 Kelvin)
		*/
		white_point* F11_2Degree() { return new white_point(0.10096f, 0.1f, 0.6437f, 0.3805f, 0.3768f); }

		//! CIE_F12 tristimulus white (2°)
		/*!
		* Represents Philips TL83, Ultralume 30 (3000 Kelvin)
		*/
		white_point* F12_2Degree() { return new white_point(0.10804f, 0.1f, 0.3922f, 0.4369, 0.4044f); }
		...
		* ICC profile PCS
		*/
		white_point* D50_10Degree() { return new white_point(0.9672f, 0.1f, 0.8142f, 0.3477f, 0.3595f); }

		//! CIE_D55 tristimulus white (10°)
		/*!
		* Represents mid-morning / mid-afternoon daylight (5503 Kelvin)
		*/
		white_point* D55_10Degree() { return new white_point(0.9579f, 0.1f, 0.9092f, 0.3341f, 0.3487f); }

		//! CIE_D65 tristimulus white (10°)
		/*!
		* Represents noon daylight, tv, sRGB color space (6504 Kelvin)
		*/
		white_point* D65_10Degree() { return new white_point(0.9481f, 0.1f, 1.0730f, 0.3138f, 0.3310f); }

		//! CIE_D75 tristimulus white (10°)
		/*!
		* Represents north sky daylight (7504 Kelvin)
		*/
		white_point* D75_10Degree() { return new white_point(0.9441f, 0.1f, 1.2064f, 0.2996f, 0.3174f); }

		//! CIE_A tristimulus white (10°)
		/*!
		* Represents incandescent / tungsten (2856 Kelvin)
		*/
		white_point* A_10Degree() { return new white_point(0.11114f, 0.1f, 0.3520f, 0.4511f, 0.4059f); }
		...
		*/
		white_point* B_10Degree() { return new white_point(0.9917f, 0.1f, 0.84349f, 0.3497f, 0.3527f); }
		...
		*/
		white_point* C_10Degree() { return new white_point(0.9728f, 0.1f, 1.1614f, 0.3103f, 0.3190f); }

		//! CIE_E tristimulus white (10°)
		/*!
		* Represents equal energy (5454 Kelvin)
		*/
		white_point* E_10Degree() { return new white_point(0.1f, 0.1f, 0.1f, 0.3333f, 0.3333f); }

		//! CIE_F1 tristimulus white (10°)
		/*!
		* Represents daylight fluorescent (6430 Kelvin)
		*/
		white_point* F1_10Degree() { return new white_point(0.9479f, 0.1f, 1.0319f, 0.3181f, 0.3355f); }

		//! CIE_F2 tristimulus white (10°)
		/*!
		* Represents cool white fluorescent (4230 Kelvin)
		*/
		white_point* F2_10Degree() { return new white_point(0.10328f, 0.1f, 0.6902f, 0.3792f, 0.3672f); }

		//! CIE_F3 tristimulus white (10°)
		/*!
		* Represents white fluorescent (3450 Kelvin)
		*/
		white_point* F3_10Degree() { return new white_point(0.10896f, 0.1f, 0.5196f, 0.4175f, 0.3832f); }

		//! CIE_F4 tristimulus white (10°)
		/*!
		* Represents warm white fluorescent (2940 Kelvin)
		*/
		white_point* F4_10Degree() { return new white_point(0.11496f, 0.1f, 0.4096f, 0.4492f, 0.3907f); }

		//! CIE_F5 tristimulus white (10°)
		/*!
		* Represents daylight fluorescent (6350 Kelvin)
		*/
		white_point* F5_10Degree() { return new white_point(0.9336f, 0.1f, 0.9863f, 0.3197f, 0.3424f); }

		//! CIE_F6 tristimulus white (10°)
		/*!
		* Represents lite white fluorescent (4150 Kelvin)
		*/
		white_point* F6_10Degree() { return new white_point(0.10214f, 0.1f, 0.6207f, 0.3865f, 0.3784f); }

		//! CIE_F7 tristimulus white (10°)
		/*!
		* Represents D65 simulator, daylight simulator (6500 Kelvin)
		*/
		white_point* F7_10Degree() { return new white_point(0.9579f, 0.1f, 1.0768f, 0.3156f, 0.3295f); }

		//! CIE_F8 tristimulus white (10°)
		/*!
		* Represents D50 simulator, sylvania F40 design 50 (5000 Kelvin)
		*/
		white_point* F8_10Degree() { return new white_point(0.9711f, 0.1f, 0.8113f, 0.3490f, 0.3594f); }

		//! CIE_F9 tristimulus white (10°)
		/*!
		* Represents cool white deluxe fluorescent (4150 Kelvin)
		*/
		white_point* F9_10Degree() { return new white_point(0.10211f, 0.1f, 0.6782f, 0.3782f, 0.3704f); }

		//! CIE_F10 tristimulus white (10°)
		/*!
		* Represents Philips TL85, Ultralume 50 (5000 Kelvin)
		*/
		white_point* F10_10Degree() { return new white_point(0.9900f, 0.1f, 0.8313f, 0.3509f, 0.3544f); }

		//! CIE_F11 tristimulus white (10°)
		/*!
		* Represents Philips TL84, Ultralume 40 (4000 Kelvin)
		*/
		white_point* F11_10Degree() { return new white_point(0.10386f, 0.1f, 0.6562f, 0.3854f, 0.3710f); }

		//! CIE_F12 tristimulus white (10°)
		/*!
		* Represents Philips TL83, Ultralume 30 (3000 Kelvin)
		*/
		white_point* F12_10Degree() { return new white_point(0.11142f, 0.1f, 0.4035f, 0.4425f, 0.3971f); }
	};
}